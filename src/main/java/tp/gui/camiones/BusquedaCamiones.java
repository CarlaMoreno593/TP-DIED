...
public class BusquedaCamiones extends JPanel{
	
	//Titulos
	private JLabel lblSubtitulo = new JLabel("Buscar Camion:");
	...
	public BusquedaCamiones(CamionTableModel tabla) {
		super();
		this.armarPanel();
	...
	private void armarPanel() {
		...
		this.add(lblSubtitulo,constraints);//Campos:
